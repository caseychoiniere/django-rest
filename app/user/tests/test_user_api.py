...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user_with_password(self):
    ...
    def test_create_token_invalid_creds(self):
        ...
        payload = {'email': 'test@test.com', 'password': 'wrong_testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 'bad', 'password': ''})
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """Test that a user can be retrieved if authed"""
        res = self.client.get(ME_URL)
    ...
    def test_update_user_profile(self):
        """Test updating user profile for authed users"""
